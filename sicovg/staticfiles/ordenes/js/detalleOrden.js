...
$(function () {
    ...
    function planes(id) {
        var planes = '<select  class="form-group-sm" name="plan' + id + '" id="plan' + id + '" style="font-size: 10px;" >' +
            '<option value="CT NEG 199 V3">CT NEG 199 V3</option>\n' +
            '<option value="CT NEG 239 V3">CT NEG 239 V3</option>\n' +
            '<option value="CT NEG 299 V3">CT NEG 299 V3</option>\n' +
            '<option value="CT NEG 399 V3">CT NEG 399 V3</option>\n' +
            '<option value="CT NEG 499 V3">CT NEG 499 V3</option>\n' +
            '<option value="CT NEG 599 V3">CT NEG 599 V3</option>\n' +
            '<option value="CT NEG 699 V3">CT NEG 699 V3</option>\n' +
            '<option value="CT NEG 799 V3">CT NEG 799 V3</option>\n' +
            '<option value="CT NEG 999 V3">CT NEG 999 V3</option>\n' +
            '<option value="CT NEG 1299 V3">CT NEG 1299 V3</option>\n' +
