    ...
    function buscarTodo() {
        tblTodo = $('#data').DataTable({
            ...
            columns: [
                ...
                {"data": "empresaDn.empresa.idCuenta"},
                {"data": "totaLineas"},
                {"data": "empleado.id"},
            ],
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        if (data == idU.value) {
                            var buttons = '<a href="/erp/detallesCuenta/'+ row.empresaDn.empresa.cuenta +'" rel="detalle" title="Detalle" type="button" class="btn btn-success btn-xs btn-flat"><i class="fas fa-clipboard"></i></a> ';
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (data == idU.value) {
                            ...
                            buttons += '<a href="#!a" rel="paternidad" title="Cambiar Paternidad" type="button" class="btn btn-dark btn-xs btn-flat"><i class="fas fa-user"></i></a> ';
                        } else {
